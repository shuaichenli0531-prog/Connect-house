                    ...
                    <div className="space-y-3 border-t border-white/10 pt-4 text-sm">
                      ...
                      {siteContent.site?.contactMobile && (
                        <p className="text-white/70">
                          <span className="text-white/50">Mobile:</span> {siteContent.site.contactMobile}
                        </p>
                      )}

                      {siteContent.site?.contactWechat && (
                        <p className="text-white/70">
                          <span className="text-white/50">WeChat:</span> {siteContent.site.contactWechat}
                        </p>
                      )}

                      {/* Social Icons */}
                      {(siteContent.site?.contactLinkedin || siteContent.site?.contactTwitter) && (
                        <div className="flex gap-3 pt-2">
                          {siteContent.site?.contactLinkedin && (
                            <a
                              href={siteContent.site.contactLinkedin}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-gold hover:text-ink"
                              aria-label="LinkedIn"
                            >
                          ...
                          {siteContent.site?.contactTwitter && (
                            <a
                              href={siteContent.site.contactTwitter}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-gold hover:text-ink"
                              aria-label="Twitter"
